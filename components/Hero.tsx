...
function Hero() {
  return (
    <section className="w-full hero flex justify-center items-center p-4 md:p-20 bg-[#fafaf5]">
      <div className="container grid grid-cols-1 md:grid-cols-5 gap-16 justify-center items-center">
        <div className="col-span-3 flex flex-col text-center md:text-justify gap-8 md:gap-6 mt-8 md:mt-0">
          <div className="flex flex-col justify-start gap-2">
            <h4 className="text-xs text-[#214842fa]">
              - Commited to Transforming Africa Healthcare -
            </h4>
            <h1 className="text-5xl md:text-5xl font-extrabold text-[#214842]">
